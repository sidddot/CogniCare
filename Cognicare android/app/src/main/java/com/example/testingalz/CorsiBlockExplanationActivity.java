...
public class CorsiBlockExplanationActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.start_test_button).setOnClickListener(v -> {
            startActivity(new Intent(CorsiBlockExplanationActivity.this, CorsiBlockTestActivity.class));
        });
    }
}
